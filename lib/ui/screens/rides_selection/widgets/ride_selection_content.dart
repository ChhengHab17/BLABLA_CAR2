...
import 'package:blablacar_2/ui/screens/rides_selection/widgets/ride_preference_modal.dart';
import 'package:blablacar_2/ui/screens/rides_selection/widgets/rides_selection_header.dart';
import 'package:blablacar_2/ui/screens/rides_selection/widgets/rides_selection_tile.dart';
import 'package:blablacar_2/ui/theme/theme.dart';
import 'package:blablacar_2/utils/animations_util.dart';
...
class RideSelectionContent extends StatelessWidget {
  ...
  void onPreferencePressed(BuildContext context) async {
    final RidePreference? selectedRidePreference =
        rideSelectionVM.currentRidePreference;
    ...
    if (newPreference != null) {
      ...
      rideSelectionVM.selectRidePreference(newPreference);
    }
  }
